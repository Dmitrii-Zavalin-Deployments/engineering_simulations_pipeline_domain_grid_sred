...
def test_domain_extraction_valid_geometry():
    """Validates correct bounding box and grid from test STEP."""
    assert TEST_STEP_PATH.exists(), "Missing test STEP file"
...
@pytest.mark.integration
def test_empty_geometry_triggers_exception(tmp_path):
...
@pytest.mark.integration
def test_resolution_scaling_effect():
